...
$sql="SELECT * FROM berita where kategori='sport' ORDER BY id_berita DESC limit $page1,4";
$qry1=mysql_query("SELECT * from berita where kategori='sport'");
$qry=mysql_query($sql);
...
for ($i=1; $i<=$a; $i++) { 
    ?>  
    <li><a href="index.php?act=sport&page=<?php echo $i;?>" ><?php echo $i; ?> </a> </li>
