...
$sql="SELECT * FROM berita where kategori='entertainment' ORDER BY id_berita DESC limit $page1,4";
$qry1=mysql_query("SELECT * from berita where kategori='entertainment'");
$qry=mysql_query($sql);
...
for ($i=1; $i<=$a; $i++) { 
    ?>  
    <li><a href="index.php?act=entertainment&page=<?php echo $i;?>" ><?php echo $i; ?> </a> </li>
